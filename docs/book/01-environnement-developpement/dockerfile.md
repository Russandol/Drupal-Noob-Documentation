...
Vu le nombre de fois où nous allons utiliser la commande Drush je vous assure que c'est indispensable !
...
Enfin il nous reste à définir le répertoir de travail par défaut dans le conteneur. Toutes les commandes RUN, CMD,
